...
import liderLogo from '../../../assets/liderLogoNegativ.png';
            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-12">
                <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-20">
                    ...
                    <div className="flex flex-col gap-6">
                        ...
                        {/* Badge */}
                        <div className="flex w-fit items-center gap-3 border border-gold-border bg-gold-subtle px-5 py-3">
                            <span className="font-display text-[1.05rem] font-semibold text-gold">
                                {t('static', 'about.badgeNumber')}
                            </span>
                            <Paragraph
                                level="p3"
                                extendClass="text-gold uppercase tracking-[0.12em]"
                            >
